...
class Quaternion {
	...
	constructor(...args:number[]|Quaternion[]){
	...
	get_sum(other:Quaternion):Quaternion{
	...
	add_euler(roll:number, pitch:number, yaw:number):void{
	...
	set_euler(roll:number, pitch:number, yaw:number):void{
	...
	get_rotated_vec(vec: Vector3):Vector3{
	...
	get_reverse_rotated_vec(vec: Vector3):Vector3{
